...
function lcm(a, b) {
  let abGcm = gcd(a, b)
  return BigNumber(a / abGcm).multipliedBy(BigNumber(b)).toString(10)
}
...
function main() {
  //console.log(BigNumber(304519437).multipliedBy(BigNumber(251772294)).toString(10));
  console.log(lcm(1827116622, 251772294));
  process.exit()
}
//main()
